...
namespace TurkcellDigitalSchool.Account.DataAccess.DataAccess.Migrations.Postgre
{
    ...
    [Migration("20230511152259_usercitizenIdNullable")]
    partial class usercitizenIdNullable
    {
            ...
            modelBuilder.Entity("TurkcellDigitalSchool.Account.Domain.Concrete.UserPackage", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_userpackages");

                    b.HasIndex("PackageId")
                        .HasDatabaseName("ix_userpackages_packageid");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_userpackages_userid");
            ...
            modelBuilder.Entity("TurkcellDigitalSchool.Account.Domain.Concrete.UserPackage", b =>
                {
                    b.HasOne("TurkcellDigitalSchool.Account.Domain.Concrete.Package", "Package")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_userpackages_packages_packageid");
                    ...
                    b.HasOne("TurkcellDigitalSchool.Account.Domain.Concrete.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_userpackages_users_userid");
