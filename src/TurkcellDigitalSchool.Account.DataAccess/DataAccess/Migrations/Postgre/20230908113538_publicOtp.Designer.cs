...
namespace TurkcellDigitalSchool.Account.DataAccess.DataAccess.Migrations.Postgre
{
    ...
    [Migration("20230908113538_publicOtp")]
    partial class publicOtp
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TurkcellDigitalSchool.Account.Domain.Concrete.PublicOneTimePassword", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<Guid>("VerificationSessionCode")
                        .HasColumnType("uuid")
                        .HasColumnName("verificationsessioncode");

                    b.HasKey("Id")
                        .HasName("pk_publiconetimepasswords");

                    b.ToTable("publiconetimepasswords", "account");
                });
