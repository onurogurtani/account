...
const QuestionIdentification = () => {
    ...
    useEffect(() => {
        if (questionOfExams.questionOfExamDetail) {
            if (questionOfExams?.questionOfExamDetail?.questionOfExamDetailLessonUnits?.length > 0) {
    ...
    const addData = async (privateData = null) => {
        try {
            ...
            if (
                newFormData.imageSolutionFileId ||
                newFormData.pdfSolutionFileId ||
                newFormData.questionOfExamState === 1
            ) {
                if (questionOfExams.questionOfExamDetail) {
        ...
        <CustomPageHeader>
                                ...
                                <CustomFormItem label="Yayın Adı" name="PublisherId">
                                    <CustomSelect
                                        onChange={(e) => {
                                            if (e !== null) {
                                                dispatch(
                                                    getBookList([{ field: 'publisherId', value: e, compareType: 0 }]),
                                                );
                                            } else {
                                                setBookData([]);
                                            }
                                    ...
                                    <Col className="infos" span={12}>
                                            ...
                                            <div style={{ widht: '100%' }}>
                                                <CustomRadioGroup
                                                    onChange={(e) => {
                                                        ...
                                                        setFormData({
                                                            ...newData,
                                                            questionOfExamState: e.target.value,
                                                        });
                                                    }}
                                                    ...
                                                    <div className="questionStateNote">
                                                        <CustomTextArea
                                                            onChange={(e) => {
                                                                setFormData({
                                                                    ...formData,
                                                                    questionStateNote: e.target.value,
                                                                });
                                                            }}
                                        ...
                                        <div className="question-info">
                                            ...
                                            <div style={{ display: 'flex' }}>
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.correctAnswerIndex === 0 && 'circle-reply-active'
                                                ...
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.correctAnswerIndex === 1 && 'circle-reply-active'
                                                    } ${formData.questionOfExamState === 1 ? 'cursor-disabled-q' : ''}`}
                                                >
                                                    B
                                                </div>
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.correctAnswerIndex === 2 && 'circle-reply-active'
                                                    } ${formData.questionOfExamState === 1 ? 'cursor-disabled-q' : ''}`}
                                                >
                                                    C
                                                </div>
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.correctAnswerIndex === 3 && 'circle-reply-active'
                                                    } ${
                                                        formData.questionOfExamState === 1 ? 'cursor-disabled-q' : ''
                                                    }  `}
                                                >
                                                ...
                                                {questionOfExams?.answerOfQuestionOfExams[4]?.file?.fileBase64 && (
                                                    <div
                                                        ...
                                                        className={`circle-reply ${
                                                            formData.correctAnswerIndex === 4 && 'circle-reply-active'
                                                        } ${
                                                            formData.questionOfExamState === 1
                                                                ? 'cursor-disabled-q'
                                                                : ''
                                        ...
                                        <div className="question-info">
                                            ...
                                            <div style={{ display: 'flex' }}>
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.difficulty === 1 && 'circle-reply-active'
                                                    } ${formData.questionOfExamState === 1 ? 'cursor-disabled-q' : ''}`}
                                                >
                                                    1
                                                </div>
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.difficulty === 2 && 'circle-reply-active'
                                                    } ${formData.questionOfExamState === 1 ? 'cursor-disabled-q' : ''}`}
                                                >
                                                    2
                                                </div>
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.difficulty === 3 && 'circle-reply-active'
                                                    } ${formData.questionOfExamState === 1 ? 'cursor-disabled-q' : ''}`}
                                                >
                                                    3
                                                </div>
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.difficulty === 4 && 'circle-reply-active'
                                                    } ${
                                                        formData.questionOfExamState === 1 ? 'cursor-disabled-q' : ''
                                                    }  `}
                                                >
                                                ...
                                                <div
                                                    ...
                                                    className={`circle-reply ${
                                                        formData.difficulty === 5 && 'circle-reply-active'
                                                    } ${formData.questionOfExamState === 1 ? 'cursor-disabled-q' : ''}`}
                                                >
                                                    5
                                                </div>
                                        ...
                                        <div className="question-info">
                                            ...
                                            <div className="starts">
                                                ...
                                                <div
                                                    ...
                                                    onClick={() => {
                                                        if (formData.questionOfExamState !== 1) {
                                                            setFormData({ ...formData, quality: 5 });
                                                        }
                                                    }}
                                                >
                                                    <StarSvg fill={formData.quality > 4 ? true : false} />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="question-info">
                                            ...
                                            <div style={{ widht: '100%' }}>
                                                <CustomRadioGroup
                                                    ...
                                                    onChange={(e) => {
                                                        setFormData({
                                                            ...formData,
                                                            questionOfExamFormal: e.target.value,
                                                        });
                                                    }}
                                            ...
                                            <div style={{ widht: '100%' }}>
                                                <CustomRadioGroup
                                                    onChange={(e) => {
                                                        setFormData({
                                                            ...formData,
                                                            questionOfExamKind: e.target.value,
                                                        });
                                                    }}
                                                    disabled={formData.questionOfExamState === 1}
                                            ...
                                            <div className="checkbox">
                                                <CustomCheckbox
                                                    ...
                                                    onChange={(e) => {
                                                        setFormData({
                                                            ...formData,
                                                            usedInSolutionVideo: e.target.checked,
                                                        });
                                                    }}
                                        ...
                                        {formData.outQuestion && (
                                            <>
                                                ...
                                                {allClassList?.find((q) => q.id === classroomId)?.schoolLevel ===
                                                    30 && (
                                                    <div>
                                                        <div className="question-info">
                                                ...
                                                onChange={async (e) => {
                                                    if (e.target.files.length > 0) {
                                                        ...
                                                        if (getFileUpload.fulfilled.match(action)) {
                                                            ...
                                                            setFormData({
                                                                ...formData,
                                                                videoSolutionFileId: action.payload.data.data.id,
                                                            });
                                                        ...
                                                        setFormData({
                                                            ...formData,
                                                            videoSolutionFileId:
                                                                questionOfExams?.questionOfExamDetail?.videoSolutionFile
                                                                    ?.id,
                                                        });
                                                    }
                                                }}
                                                ...
                                                onChange={async (e) => {
                                                    if (e.target.files.length > 0) {
                                                        ...
                                                        if (getFileUpload.fulfilled.match(action)) {
                                                            ...
                                                            setFormData({
                                                                ...formData,
                                                                imageSolutionFileId: action.payload.data.data.id,
                                                            });
                                                            successDialog({
                                                                title: 'Başarılı',
                                                                message: 'Eklendi güncelleyebilirsiniz.',
                                                            });
                                                        } else {
                                                            setFileUploadLoading(false);
                                                            errorDialog({
                                                        ...
                                                        setFormData({
                                                            ...formData,
                                                            imageSolutionFileId:
                                                                questionOfExams?.questionOfExamDetail?.imageSolutionFile
                                                                    ?.id,
                                                        });
                                                    }
                                                }}
                                                ...
                                                onChange={async (e) => {
                                                    if (e.target.files.length > 0) {
                                                        ...
                                                        if (getFileUpload.fulfilled.match(action)) {
                                                            setFormData({
                                                                ...formData,
                                                                pdfSolutionFileId: action.payload.data.data.id,
                                                            });
                                                            successDialog({ title: 'Başarılı', message: 'Eklendi' });
                                                            setFileUploadLoading(false);
                                                        } else {
                                                        ...
                                                        setFormData({
                                                            ...formData,
                                                            pdfSolutionFileId:
                                                                questionOfExams?.questionOfExamDetail?.pdfSolutionFile
                                                                    ?.id,
                                                        });
                                                    }
                                                }}
            ...
            {showModal && (
                <div className="earnings-modal">
                    ...
                    >
                        <EarningsChoice updateStatus={updateStatus} classroomId={classroomIdInfo} />
                    </CustomModal>
                </div>
            )}
        </CustomPageHeader>
