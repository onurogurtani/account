...
const OrganisationTypesListTable = () => {
    ...
    const columns = [
        ...
        {
            title: 'Kurum Tipi',
            dataIndex: 'isSingularOrganisation',
            key: 'isSingularOrganisation',
            sorter: (a, b) => b.IsSingularOrganisation - a.IsSingularOrganisation,
            sortOrder: sortedInfo.columnKey === 'isSingularOrganisation' ? sortedInfo.order : null,
            render: (text, record) => {
                return <div>{text ? 'Tekil Kurum' : 'Çoklu Kurum'}</div>;
            },
        },
        {
            title: 'Kurum Türü',
