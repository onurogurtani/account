...
const Login = lazy(() =>
  import('./login').then(({ default: Component }) => ({ default: Component })),
);
...
const ResetPassword = lazy(() =>
  import('./resetPassword').then(({ default: Component }) => ({ default: Component })),
);
const NotFound = lazy(() =>
  import('./errors/NotFound').then(({ default: Component }) => ({ default: Component })),
);
const Maintenance = lazy(() =>
  import('./errors/Maintenance').then(({ default: Component }) => ({ default: Component })),
);
const Dashboard = lazy(() =>
  import('./dashboard').then(({ default: Component }) => ({ default: Component })),
);
const MyProfile = lazy(() =>
  import('./myProfile').then(({ default: Component }) => ({ default: Component })),
);
