...
{
    public class ForgotPasswordSendLinkChangePasswordCommand : IRequest<IResult>
    {
        ...
        public class ForgotPasswordSendLinkCheckCommandHandler : IRequestHandler<ForgotPasswordSendLinkChangePasswordCommand, IResult>
        {
            ...
            public async Task<IResult> Handle(ForgotPasswordSendLinkChangePasswordCommand request, CancellationToken cancellationToken)
            {
